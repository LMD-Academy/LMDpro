...
export const modulesData: { [key: string]: { title: string; audioSrc?: string; paragraphs: any[] } } = {
  ...
  'ai-for-business': {
    ...
    paragraphs: [
        { type: 'h2', text: '1. Introduction: Understanding the AI Revolution' },
        { type: 'p', text: 'This module introduces the foundational concepts of AI in a business context, exploring how AI-driven agents and systems are architected and how they can be leveraged to create value and drive innovation.'}
    ]
  },
